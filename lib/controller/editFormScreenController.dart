...
class EditFormScreenController extends GetxController {
  ...
  void loadQuestions() async {
    ...
    print(passedData);
    storedFormId = passedData["formId"];
    categoryId = passedData["categoryId"];
    villageOrWardId = passedData["surveyId"];
    print(formId);
    try {
      ...
      final data = response["data"]["form"] as Map<String, dynamic>?;
      id.value = data?["id"];
  ...
  submit(context) async {
    ...
    try {
      final authUserData = {
        "url": ApiEndPoint.updateProfile + "${storedFormId}",
        "village_id": categoryId == 2 ? villageOrWardId : "",
        "ward_id": categoryId == 1 ? villageOrWardId : "",
        "answers": result,
      };
      ...
      var response = await ApiServices().uploadFormDataWithFiles(
        url: ApiEndPoint.surveyUpdate + "${storedFormId}",
        villageId: categoryId == 2 ? villageOrWardId.toString() : "",
        wardId: categoryId == 1 ? villageOrWardId.toString() : "",
  ...
  //   storedFormId = argus["formId"];
  //   var res = await ApiServices().getData(
  //     url: "${ApiEndPoint.editFormsLang}en${ApiEndPoint.surveyId}${storedFormId}",
  //   );
  //   log(res.toString());
  // }
}
