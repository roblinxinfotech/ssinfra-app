...
class VillageToTalukaScreen extends StatefulWidget {
  const VillageToTalukaScreen({super.key});

  @override
  State<VillageToTalukaScreen> createState() => _VillageToTalukaScreenState();
}

class _VillageToTalukaScreenState extends State<VillageToTalukaScreen> {
  VillageToTalukaScreenController villageToTalukaScreenController = Get.put(
    VillageToTalukaScreenController(),
  );
          ...
          child: Column(
            children: [
                  ...
                  children: [
                    ...
                    Obx(() {
                      return GestureDetector(
                        onTap: () {
                          villageToTalukaScreenController.hideShowSearch();
                        },
                        child:
                            villageToTalukaScreenController.showSearch == false
                            ? Image.asset(
              ...
              Padding(
                ...
                child: Obx(() {
                  return villageToTalukaScreenController.showSearch.value ==
                          true
                      ? Container(
                          height: 40,
                          child: TextFormField(
                            onChanged: (a) async {
                              villageToTalukaScreenController.searchText = a
                                  .toString();
                              // await teamScreenController.sortData();
                              await villageToTalukaScreenController
                                  .searchItem();
                            },
                            controller: villageToTalukaScreenController
                                .searchController
                                .value,
              ...
              Expanded(
                child: RefreshIndicator(
                  onRefresh: () async {
                    await villageToTalukaScreenController.getVillageList();
                    await villageToTalukaScreenController.searchItem();
                  },
                  child: Column(
                    children: [
                      Obx(() {
                        return villageToTalukaScreenController.loader.value ==
                                true
                            ? Flexible(
                                child: Center(
                                  child: Image.asset(
                            ...
                            : villageToTalukaScreenController.errorShow == true
                            ? Flexible(
                                child: Center(
                                  child: Column(
                            ...
                            : Flexible(
                                child: Container(
                                  ...
                                  child: ListView.builder(
                                    ...
                                    itemCount: villageToTalukaScreenController
                                        .villageToTalukaList
                                        .value
                                        ?.length,
                                                  ...
                                                  children: [
                                                    ...
                                                    Flexible(
                                                      child: CommonWidgets().commonText(
                                                        text:
                                                            "${villageToTalukaScreenController.villageToTalukaList?[index].name}",
                                                        fontSize: 16.sp,
                                                        fontColor: AppColors()
                                                            .color1E1E1E,
                                                        fontFamily:
