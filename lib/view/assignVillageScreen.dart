...
class AssignVillageScreen extends StatefulWidget {
  const AssignVillageScreen({super.key});

  @override
  State<AssignVillageScreen> createState() => _AssignVillageScreenState();
}

class _AssignVillageScreenState extends State<AssignVillageScreen> {
  AssignVillageScreenController assignVillageScreenController = Get.put(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
          ...
          child: Column(
            children: [
                  ...
                  children: [
                    ...
                    Obx(() {
                      return GestureDetector(
                        onTap: () {
                          assignVillageScreenController.hideShowSearch();
                        },
                        child: assignVillageScreenController.showSearch == false
                            ? Image.asset(
              ...
              Padding(
                ...
                child: Obx(() {
                  return assignVillageScreenController.showSearch.value == true
                      ? Container(
                          height: 40,
                          child: TextFormField(
                            onChanged: (a) async {
                              assignVillageScreenController.searchText = a
                                  .toString();
                              // await teamScreenController.sortData();
                              await assignVillageScreenController.searchItem();
                            },
                            controller: assignVillageScreenController
                                .searchController
                                .value,
                  ...
                  child: Row(
                    children: [
                      ...
                      Expanded(
                        child: GestureDetector(
                          onTap: () async {
                            ...
                            assignVillageScreenController.searchItem();
                          },
                          child: Container(
                      ...
                      Expanded(
                        child: GestureDetector(
                          onTap: () async {
                            assignVillageScreenController.groupValue.value = 1;
                            assignVillageScreenController.searchItem();
                          },
                          child: Container(
                            padding: EdgeInsets.symmetric(vertical: 12),
                    ...
                    children: [
                      Obx(() {
                        return assignVillageScreenController.loader.value ==
                            ...
                            : assignVillageScreenController.errorShow == true
                            ? Flexible(
                                child: Center(
                                  child: Column(
                            ...
                            ? Expanded(
                                child: ListView.builder(
                                  ...
                                  itemCount: assignVillageScreenController
                                      .villageList
                                      ?.length,
      ...
      bottomNavigationBar: Obx(() {
        return assignVillageScreenController
                        .villageListAssignModel
                        .value
                        .data
                        ?.length !=
            ...
            ? Column(
                ...
                children: [
                  GestureDetector(
                    onTap: () async {
                      await assignVillageScreenController.submit(context);
                    },
                    child: Container(
