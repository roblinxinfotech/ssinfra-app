...
import 'package:ssinfra/controller/editFormScreenController.dart';
...
class _EditFormScreenState extends State<EditFormScreen> {
  EditFormScreenController controller = Get.put(EditFormScreenController());
...
class _NumberFieldWidget extends StatefulWidget {
  ...
  final EditFormScreenController controller;
